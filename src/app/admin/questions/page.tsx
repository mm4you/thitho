      ...
      <div className="flex flex-wrap items-center justify-between border-b border-slate-800 pb-4 gap-4">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-white uppercase flex items-center gap-2">
            ...
            NGÂN HÀNG CÂU HỎI & CẤU HÌNH THỜI GIAN VÒNG
          </h1>
          <p className="text-xs text-slate-400 font-medium">
            Tự do soạn đề, nhập đáp án chuẩn và cài đặt thời gian thi đấu cho từng vòng
          </p>
        </div>

        {savedAlert && (
          <span className="text-xs font-bold text-emerald-400 bg-emerald-950/60 px-3 py-1.5 rounded-lg border border-emerald-500/60 flex items-center gap-1">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs h-9 px-4 gap-1.5 rounded-xl cursor-pointer"
          >
